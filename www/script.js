...
$(window).load(function() {
    ...
    $('#load').click(function() {
        $('#dialog').html('<div class="contents">Pick one of the sample images below or upload an image of your own:<br><br>' +
            '<img class="loader" src="samples/orange.jpg" height="100">' +
            '<img class="loader" src="samples/image.jpg" height="100">' +
            '<img class="loader" src="samples/Wolf.jpg" height="100">' +
            '<img class="loader" src="samples/Flowers.jpg" height="100">' +
            '<img class="loader" src="samples/Bryce.jpg" height="100">' +
            '<img class="loader" src="samples/Copenhagen.jpg" height="100">' +
            '</div>' +
